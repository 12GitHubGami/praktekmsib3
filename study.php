    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 mb-80">
        <div class="d-flex">
          ...
          <div>
            <p class="text-dark mb-1">Now</p>
            <h4>Informatika</h4>
            <p class="mb-0 text-light">Universitas Amikom Purwokerto</p>
          </div>
        </div>
      </div>
      <div class="col-lg-6 col-md-6 mb-80">
        <div class="d-flex">
          ...
          <div>
            ...
            <h4>MIPA</h4>
            <p class="mb-0 text-light">SMA N Jatilawang</p>
          </div>
        </div>
      </div>
      <div class="col-lg-6 col-md-6 mb-80">
        <div class="d-flex">
          ...
          <div>
            ...
            <h4>SMP</h4>
            <p class="mb-0 text-light">SMP N 1 Wangon</p>
          </div>
        </div>
      </div>
      <div class="col-lg-6 col-md-6 mb-80">
        <div class="d-flex">
          ...
          <div>
            <p class="text-dark mb-1">2013</p>
            <h4>SD</h4>
            <p class="mb-0 text-light">SD N Karangkemiri 02</p>
          </div>
        </div>
      </div>
    </div>

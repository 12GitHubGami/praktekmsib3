  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-11 mx-auto">
        <h1 class="text-white font-tertiary">Hi! I’m <br> Gamiat <br> Web Developer</h1>
      </div>
    </div>
  </div>
      ...
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="card shadow text-center">
          ...
          <div class="card-footer bg-white">
            <h4 class="card-title">Web Design (70%)</h4>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="card shadow text-center">
          ...
          <div class="card-footer bg-white">
            <h4 class="card-title">UI/UX Design (90%)</h4>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="card shadow text-center">
          ...
          <div class="card-footer bg-white">
            <h4 class="card-title">Premier Pro (60%)</h4>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="card shadow text-center">
          <div class="position-relative rounded-top progress-wrapper" data-color="#ffbcaa">
            <div class="wave" data-progress="50%"></div>
          </div>
          <div class="card-footer bg-white">
            <h4 class="card-title">Web App (50%)</h4>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row justify-content-around">
      ...
      <div class="col-lg-3 col-md-4 text-center">
        ...
        <p class="mb-0">Jan 2019 - Apr 2019</p>
        <h4>Wordpress Developer</h4>
        <h6 class="text-light">Gustifarm</h6>
      </div>
      <div class="col-lg-3 col-md-4 text-center">
        <img src="images/experience/icon-2.png" alt="icon">
        <p class="mb-0">Feb 2022 - Jul 2022</p>
        <h4>Studi UI/UX Research & Design</h4>
        <h6 class="text-light">Binar Academy</h6>
      </div>
      <div class="col-lg-3 col-md-4 text-center">
        <img src="images/experience/icon-1.png" alt="icon">
        <p class="mb-0">Ags 2022 - Present</p>
        <h4>Studi Fullstack Web Developer</h4>
        <h6 class="text-light">PT. Nurul Fikri Cipta Inovasi</h6>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h2 class="section-title text-white mb-5">words of wisdom</h2>
      </div>
      <div class="col-lg-10 mx-auto testimonial-slider">
        <!-- slider-item -->
        <div class="text-center testimonial-content">
          <i class="ti-quote-right text-white icon mb-4 d-inline-block"></i>
          <p class="text-white mb-4">Penyesalan terbesar dalam hidup adalah menjadi apa yang <b>Orang Lain inginkan</b> </strong>, Daripada menjadi <b>diri sendiri</b></p>
          <!-- <img class="img-fluid rounded-circle mb-4 d-inline-block" src="images/testimonial/client-1.png"
            alt="client-image"> -->
          <h4 class="text-white">Anonim</h4>
        </div>
        <!-- slider-item -->
        <div class="text-center testimonial-content">
          <i class="ti-quote-right text-white icon mb-4 d-inline-block"></i>
          <p class="text-white mb-4">Jangan malu dengan<strong> Kegagalan </strong>belajarlah darinya dan mulai lagi.</p>
          <!-- <img class="img-fluid rounded-circle mb-4 d-inline-block" src="images/testimonial/client-1.png"
            alt="client-image"> -->
          <h4 class="text-white">Anonim</h4>
        </div>
        ...
        <div class="text-center testimonial-content">
          <i class="ti-quote-right text-white icon mb-4 d-inline-block"></i>
          <p class="text-white mb-4">Waktumu terbatas, jadi jangan sia-siakan dengan menjalani hidup orang lain. Jangan terjebak oleh dogma - yaitu hidup dengan hasil pemikiran orang lain.</p>
          <!-- <img class="img-fluid rounded-circle mb-4 d-inline-block" src="images/testimonial/client-1.png"
            alt="client-image"> -->
          <h4 class="text-white">Steve Jobs</h4>
        </div>
      </div>
    </div>
  </div>

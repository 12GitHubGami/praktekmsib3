...
<section class="section">
  <div class="container">
    <div class="row mb-5">
      <div class="col-12">
        <div class="btn-group btn-group-toggle justify-content-center d-flex" data-toggle="buttons">
          ...
          <label class="btn btn-sm btn-primary">
            <input type="radio" name="shuffle-filter" value="frontend" />Front End
          </label>
          <label class="btn btn-sm btn-primary">
            <input type="radio" name="shuffle-filter" value="apps" />Web Apps
          </label>
        </div>
      </div>
    </div>
    <div class="row shuffle-wrapper">
      ...
      <div class="col-lg-4 col-6 mb-4 shuffle-item" data-groups="[&quot;frontend&quot;]">
        <div class="position-relative rounded hover-wrapper">
      ...
      <div class="col-lg-4 col-6 mb-4 shuffle-item" data-groups="[&quot;apps&quot;]">
        <div class="position-relative rounded hover-wrapper">
